  ...
  public static class Mail
  {
    ...
    public static void CheckMail()
    {
      ...
      if (!Game1.player.hasOrWillReceiveMail(initialRegressionLetterTitle))
      {
        ...
        initialSupplies.Add(new Underwear(UnderwearConstants.TrainingPants, 5)); // training pants are washable, they might be a good start equipment and are "not that great"
        initialSupplies.Add(new Underwear(UnderwearConstants.JojaDiaper, 25)); // joja diapers are cheap and the player would want to replace them at some point, but they are a good night diaper
