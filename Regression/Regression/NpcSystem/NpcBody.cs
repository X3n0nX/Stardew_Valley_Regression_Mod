    ...
    public class NpcBody
    {
        ...
        public bool canGetChangedByPlayerVeryNice
        {
            get
            {
                ...
                if (!Regression.ChildrenAndDiapers && (npc.Name.ToLower() == NpcConstants.NpcVincent || npc.Name.ToLower() == NpcConstants.NpcJas)) return false;
